	...
	\caption{Matriz Curricular do Curso Superior em Tecnologia em Análise e Desenvolvimento de Sistemas.}
		...
		\resizebox{\textwidth}{!}{%
			\begin{tabular}{|l|l|c|c|c|c|c|c|}
				\hline
				\textbf{Núcleo}                               
				& \textbf{Disciplinas}                          & \textbf{1º semestre} & \textbf{2º semestre} & \textbf{3º semestre} & \textbf{4º semestre} & \textbf{5º semestre} & \textbf{CH}   \\ \hline
				...
				& Bancos de Dados II                            &                      &                      & 54                   &                      &                      & 54            \\ \cline{2-8} 
