...
\begin{itemize}
	...
	\item \textbf{Bibliografia complementar}
	\begin{enumerate}
		\item \cite{prikladnicki2014metodos}~\footnote{Não tem na biblioteca do câmpus Formosa.}
		\item \cite{hirama2012engenharia}~\footnote{Não tem na biblioteca do câmpus Formosa.}
		\item \cite{engholm2010engenharia}~\footnote{Não tem na biblioteca do câmpus Formosa.}
	\end{enumerate} 
\end{itemize}
...
\begin{itemize}
	...
	Métodos de Aprendizagem Automática: Supervisionados (Regressão e Classificação) e Não-supervisionados (Clusterização);
