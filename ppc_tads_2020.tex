...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \cite{larman_braga_tortello_joão_2008}
	\end{enumerate}
	\item \textbf{Bibliografia complementar}
	\begin{enumerate}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \cite{cormen2002algoritmos}
		\item \cite{tanembaum_langsam_augenstein_2010}
		\item \cite{lafore2004estruturas}
	\end{enumerate}
	\item \textbf{Bibliografia complementar}
	\begin{enumerate}
		\item \cite{ascencio2010estruturas}
		\item \cite{szwarcfiter1994estruturas}	
		\item \cite{eldeweiss_galante_2009}
		\item \cite{silva2007estrutura}
		\item \cite{forbellone_eberspächer_2005}	
	\end{enumerate}	
\end{itemize}
\nameref{tab:matriz}
